<?php require_once "./account/controllerUserData.php"; ?>
<?php 
...
if($email != false && $password != false){
    ...
    if($run_Sql){
        ...
        if($status == "verified"){
            if($code != 0){
                header('Location: ./account/reset-password.php');
            }
        }else{
            header('Location: ./account/user-otp.php');
        }
    }
}else{
    header('Location: ./account/login-user.php');
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <header id="header">
        <div class="strip d-flex justify-content-between px-4 py-1 bg-light">
            ...
            <div class="font-size-14 font-rale pt-2">
                <a href="./account/signup-user.php" class="px-3 border-right border-left text-dark">My Profile</a>
